...
public class InstructorManager extends UserManager {
	...
	public void CreateACourse(Instructor instructor,String educationName) {
		System.out.println("Sayýn "+instructor.name+" "+educationName+" adlý kursunuz oluþturuldu.");
		
		
	}
	
	public void RemoveACourse(Instructor instructor,String educationName) {
		System.out.println("Sayýn "+instructor.name+" "+educationName+" adlý kursunuz kaldýrýldý.");
	...
	public void getCountOfStudentsInTheCourse(Instructor instructor,String educationName) {
		...
		System.out.println("Sayýn "+instructor.name+" kursundaki öðrenci sayýsý ...dýr"); // bir course nesnesi oluþturup oradaki öðrenci sayýsýný döndüreceðiz
	}
